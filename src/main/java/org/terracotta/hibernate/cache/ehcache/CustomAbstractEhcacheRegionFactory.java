 ...
 * @author Alex Snaps
 * @author Fabien Sanglier - Modified to use the CustomHibernateEhcacheUtils class
 */
abstract class CustomAbstractEhcacheRegionFactory implements RegionFactory {
    ...
    private static final EhCacheMessageLogger LOG = Logger.getMessageLogger(
            ...
            CustomAbstractEhcacheRegionFactory.class.getName()
    );
    ...
    /**
     * {@link org.hibernate.cache.ehcache.internal.strategy.EhcacheAccessStrategyFactory} for creating various access strategies
     */
    ...
    private Ehcache getCache(String name) throws CacheException {
        try {
            ...
            HibernateEhcacheTerracottaUtils.validateEhcache(cache);
            return cache;
        }
    ...
    protected URL loadResource(String configurationResourceName) {
        ...
        if ( url == null ) {
            ...
            if ( url == null ) {
                url = CustomAbstractEhcacheRegionFactory.class.getResource( configurationResourceName );
            }
            if ( url == null ) {
                try {
     ...
     * <p/>
     * We are conservative here in specifying {@link org.hibernate.cache.spi.access.AccessType#READ_WRITE} so as to follow the mantra of "do no harm".
     * <p/>
